...
public class GasCentrifugeScreenHandler extends ScreenHandler
{
    ...
    protected GasCentrifugeScreenHandler(ScreenHandlerType<?> containerTypeIn, int id, PlayerInventory playerInventoryIn, IInventory furnaceInventoryIn, PropertyDelegate p_i50104_6_, PacketBuffer buf) {
        super(containerTypeIn, id);
        assertInventorySize(furnaceInventoryIn, 6);
        assertIntArraySize(p_i50104_6_, 7);
        this.furnaceInventory = furnaceInventoryIn;
        this.delegate = p_i50104_6_;
