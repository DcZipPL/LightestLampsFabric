...
public class LightestLampsMod
{
    ...
    public static class RegistryEvents
    {
        ...
        public static void registerTE(RegistryEvent.Register<TileEntityType<?>> evt)
        {
            ...
            evt.getRegistry().register(TileEntityType.Builder.create(AntiLampBlockEntity::new,ModBlocks.ANTI_LAMP.get()).build(null).setRegistryName("antilamp_te"));
            ...
            TileEntityType<AlphaLampBlockEntity> type0 = TileEntityType.Builder.create(AlphaLampBlockEntity::new,ModBlocks.ALPHA_LAMP.get()).build(null);
            type0.setRegistryName(MOD_ID, "alfa_te");

            TileEntityType<BetaLampBlockEntity> type1 = TileEntityType.Builder.create(BetaLampBlockEntity::new,ModBlocks.BETA_LAMP.get()).build(null);
