...
public class AlphaLampBlockEntity extends TileEntity implements ITickableTileEntity
{
    private int cooldown = 0;

    public AlphaLampBlockEntity(TileEntityType<?> type)
    {
        super(type);
    }

    public AlphaLampBlockEntity()
    {
