...
public class AbyssalLanternBlockEntity extends TileEntity implements ITickableTileEntity
{
    private int cooldown = 0;

    //Delta
    public AbyssalLanternBlockEntity(TileEntityType<?> type)
    {
        super(type);
    }

    public AbyssalLanternBlockEntity()
    {
