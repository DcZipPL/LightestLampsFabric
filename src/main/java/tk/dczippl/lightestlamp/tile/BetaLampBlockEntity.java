...
public class BetaLampBlockEntity extends TileEntity implements ITickableTileEntity
{
    private int cooldown = 0;

    public BetaLampBlockEntity(TileEntityType<?> type)
    {
        super(type);
    }

    public BetaLampBlockEntity()
    {
