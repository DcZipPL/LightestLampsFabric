...
public class ModBlockEntities
{
    ...
    //public static BlockEntityType<GasCentrifugeTile> CENTRIFUGE_BE = FabricBlockEntityTypeBuilder.create(GasCentrifugeTile::new,ModBlocks.GLOWSTONE_CENTRIFUGE).build();
