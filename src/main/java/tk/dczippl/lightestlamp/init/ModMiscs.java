...
public class ModMiscs {
	...
	public static final RegistryKey<ItemGroup> LAMPS_TAB = RegistryKey.of(RegistryKeys.ITEM_GROUP, new Identifier(MOD_ID, "lamps"));
	...
	public static void init() {
		Registry.register(Registries.ITEM_GROUP, LAMPS_TAB, FabricItemGroup.builder()
